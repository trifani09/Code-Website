...
WHERE request.id_status= 1 OR request.id_status = 2";
  ...
  ?>
            <tbody>
              <tr>
                ...
                <td colspan="2">
                  <a href="konfirmasi_request.php?id=<?=$trans['id']?>"><button class="btn btn-success"><i class="fa fa-check"></i> Konfirmasi</button></a></td>
              <?php }else{?>
              	<td colspan="2">
                  <a href="selesai_request.php?id=<?=$trans['id']?>"><button class="btn btn-info"><i class="fa fa-bookmark"></i> Selesai</button></a></td>
