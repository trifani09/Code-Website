  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="panel panel-heading">
            <h3>DAFTAR REQUEST YANG SEDANG DI PROSES</h3><hr class="pg-titl-bdr-bta"></hr>
      </div>
            <table class="table">
              <thead>
                <tr>
...
WHERE request.id_status = 2 AND request.id_user='$id_user'";
  ...
  ?>
            <tbody>
              <tr>
                ...
                <td colspan="2">
                  <a href="cetak_pdf.php?id=<?=$trans['id']?>"><button class="btn btn-info"><i class="fa fa-download"></i> Cetak PDF</button></a></td>
