	...
	<body background="img/background2.jpg" style="background-size:cover;">
		<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
			  ...
			  <div class="first-row">
					...
					<h2 class="first-login">Form Peminjaman Alat</h2>
			  </div>
					<form method="post" action="tambah_request_process.php">
					  ...
					  <div class="input-group">
						<input type="text"  name="Alat_yang_dipinjam" class="form-control" placeholder="Alat yang dipinjam" required></input>
						<span class="input-group-addon">
						  <span class="fa fa-clipboard fa-fw"></span>
						</span>
					  </div>
					  <div class="input-group">
						<input type="text"  name="Luas_Tanah" class="form-control" placeholder="Luas Tanah" required></input>
						<span class="input-group-addon">
						  <span class="fa fa-clipboard fa-fw"></span>
						</span>
					  </div>
					  <div class="input-group">
						<input type="number"  name="Jumlah_yang_dipinjam" class="form-control" placeholder="Jumlah yang dipinjam" required></input>
						<span class="input-group-addon">
					  ...
					  <div class="input-group">
						<input type="date" name="Tanggal_Peminjaman" class="form-control" placeholder="Tanggal Peminjaman" required></input>
						<span class="input-group-addon">
						  <span class="fa fa-calendar fa-fw"></span>
						</span>
					  </div>
