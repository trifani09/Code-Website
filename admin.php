...
<html lang="en">
	...
	<body>
		...
		?>
		<center>
    <h3>GRAFIK USER</h3><hr class="pg-titl-bdr-btm"></hr>
...
<tbody>
	<tr>
		...
		<td><?= $row['tanggal_lahir'] ?></td>
		<td><?= $row['NIK'] ?></td>
		<td><a href="update_data.php?id=<?= $row['id'] ?>"class="btn btn-komentar btn-lg">Edit</a></td>
		<td><a href="functions.php?del=true&id=<?= $row['id'] ?>" class="btn btn-komentar btn-lg">Hapus</a></td>
	</tr>
</tbody>
<?php
	}
...
<section class="product">
					<a href="tambah_penduduk.php">
						<button class="btn btn-tambah"><i class="fa fa-plus-circle"> Tambah Penduduk</i></button>
					</a>
		</section>
